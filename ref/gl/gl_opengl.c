...
CVAR_DEFINE_AUTO( r_lockpvs, "0", FCVAR_ARCHIVE, "lockpvs area at current point (pvs test)" );
CVAR_DEFINE_AUTO( r_lockfrustum, "0", FCVAR_ARCHIVE, "lock frustrum area at current point (cull test)" );
