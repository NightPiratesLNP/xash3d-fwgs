...
static CVAR_DEFINE_AUTO( cl_upmax, "512", FCVAR_ARCHIVE, "max allowed incoming fragment size (recommended value is 1024)" );
...
static CVAR_DEFINE_AUTO( cl_advertise_engine_in_name, "0", FCVAR_PROTECTED, "add [Xash3D] to the nickname when connecting to GoldSrc servers" );
